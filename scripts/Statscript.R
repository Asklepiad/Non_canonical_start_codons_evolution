...
write.csv(cog_columns_all, glue("./{org_short}_COG_precomputed.csv"))
...
write.csv(cog_pivot_without_s_and_nulls, file=glue("./{org_short}_COG_start.csv"))
...
sink(glue("../{org_short}/data/for_eggnog_{org_short}.fa"))
